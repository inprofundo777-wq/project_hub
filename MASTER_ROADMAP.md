...
**Полная сверка проекта:** 2026-09-21 — актуализация карты после межветочной проверки  
...
- ◐ исследователь выполняет ограниченную проверку Матфея 6:19–34 и Луки 12:13–34;
...
- ○ руководитель исследования принимает или возвращает результат текстовой проверки;
- ○ директор лаборатории формулирует следующий маршрут, а Owner принимает отдельное решение;
...
1. Исследовательская лаборатория завершает ограниченную текстовую проверку и корректно проходит принятие результата и новый маршрут.
