...
**СЕЙЧАС → этап 8: практический тест исправленного поведения; затем итоговая контрольная точка.**
...
Этап 7: перенос проверен (22/22) → этап 8: практическая проверка → этап 9: итог / Snapshot. Long-term Re-entry отложен.
